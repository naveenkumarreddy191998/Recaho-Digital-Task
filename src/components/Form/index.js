...
class Test extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="contaner-field ">
        <div className=" container-input border col-sm-12 col-lg-6 col-md-12">
          <div>
            <div>
        ...
        <div className="container-Demo-description">
            <img src="	https://tmbill.com/img/tmbill_request_for_demo.png" alt=""/>
        </div>
      </div>
    );
  }
